...
registerAutomodTab({
    ...
    render: async (container) => {
        container.innerHTML = `
            <div class="card">
                <div class="card-title">AutoMod Discord</div>
                <p style="color:var(--text-secondary);font-size:.9rem">
                    Pilotez depuis ce dashboard les règles AutoMod natives de Discord : mots interdits, liens, mentions de masse, spam. Les filtres restent appliqués par Discord, en amont du bot.
                </p>
