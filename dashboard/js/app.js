...
async function loadPage(page) {
    ...
    switch (page) {
        ...
        case 'erasure':    await loadErasure(content, currentGuild.id); content.insertAdjacentHTML('afterbegin', getMobileBackHtml()); break;
        case 'breach':     await loadBreach(content); content.insertAdjacentHTML('afterbegin', getMobileBackHtml()); break;
        case 'owner':      await loadOwner(content); content.insertAdjacentHTML('afterbegin', getMobileBackHtml()); break;
        default:
